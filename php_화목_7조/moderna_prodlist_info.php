<?php
	...
	$sql = "SELECT * FROM `systemdb`.`prodlist tbl` WHERE `prodlist tbl`.`prodlist_pharmaceuticalCom` = 'Moderna'";
	...
	echo "<br><h3> <a href='moderna_prodlist_info_insert.html'> 생산내역 신규등록</a></h3>";
	echo "<h3> <a href='moderna_main.html'> <--초기화면</a></h3> ";
	echo "<h1> 모더나 백신 생산내역 조회 결과 </h1>";
	...
	while($row = mysqli_fetch_array($ret)) {
		...
		echo "<TD>", "<a href= 'moderna_prodlist_info_update.php?prodNumber=", $row['prodNumber']. "'>수정</a></TD>";
