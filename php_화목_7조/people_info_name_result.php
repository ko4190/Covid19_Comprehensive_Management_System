...
<?php
     ...
     $ret = mysqli_query($con, $sql);
      if($ret) {
       ...
       if ($count==0) {
         echo $_GET['name']." 일치하는 이름의 국민이 없음!!!"."<br>";
         ...
         exit();
          ...
          echo "<br> <a href='goverment.phpl'> <--초기화면</a> ";
          exit();
      }
