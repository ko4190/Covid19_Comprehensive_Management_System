...
$sql .=" VALUES ('Yeungnam', '$Hospitalization_date','$Resident_registration_number','$Date_of_the_COVID19_test', 'Y', '$Record_of_vaccination','$Date_of_1st_vaccination','$Date_of_2nd_vaccination','$Side_effects_of_vaccination','$Vaccine_number')";
...
echo "<br><br> <a href='patient_YH.php'> <--초기화면</a> ";
?>
