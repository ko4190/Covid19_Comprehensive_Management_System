<?php
   ...
   WHERE  `systemdb`.`patient tbl`.`Resident registration number` = '".$_GET['Resident_registration_number']."'";
...
<h1> 환자 정보 수정 </h1>
<FORM METHOD="post"  ACTION="Yeungnam University_patient_info_update_result.php">
	...
	백신 1차 접종일 : <INPUT TYPE ="text" NAME="Date_of_1st_vaccination" VALUE=<?php echo $Date_of_1st_vaccination ?> READONLY> <br>
	백신 2차 접종일 : <INPUT TYPE ="text" NAME="Date_of_2nd_vaccination" VALUE=<?php echo $Date_of_2nd_vaccination ?> READONLY> <br>
	백신 부작용 유무 : <INPUT TYPE ="text" NAME="Side_effects_of_vaccination" VALUE=<?php echo $Side_effects_of_vaccination ?>> <br>
	백신 넘버 : <INPUT TYPE ="text" NAME="Vaccine_number" VALUE=<?php echo $Vaccine_number ?> READONLY> <br>
	<BR>
	<INPUT TYPE="submit"  VALUE="정보 수정">
    <br> <h3> <a href='patient_YH.php'> <--환자 조회 화면</a> </h3>
