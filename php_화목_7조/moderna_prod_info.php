<?php
	...
	$sql = "SELECT * FROM `systemdb`.`prodplan tbl` WHERE `prodplan tbl`.`prodplan_pharmaceuticalCom` = 'Moderna'";
	...
	echo "<br><h3> <a href='moderna_main.html'> <--초기화면</a></h3> ";
	echo "<h1> 백신 생산정보 조회 결과 </h1>";
	...
	while($row = mysqli_fetch_array($ret)) {
		...
		echo "<TD>", "<a href= 'moderna_prod_info_update.php?prodplan_pharmaceuticalCom=", $row['prodplan_pharmaceuticalCom']. "'>수정</a></TD>";
		echo "</TR>";
	}
