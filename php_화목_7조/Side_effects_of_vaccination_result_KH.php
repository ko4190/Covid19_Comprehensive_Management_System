...
<?php
 ...
 $sql ="SELECT * FROM systemdb.`people tbl` AS p LEFT JOIN systemdb.`patient tbl` AS pat ON p.`Resident registration number`=pat.`Resident registration number` where pat.`Side effects of vaccination`='$Side_effects_of_vaccination' AND `hospital tbl_Hospital Name`='Kyungpook'";
