...
$sql ="SELECT * FROM  `systemdb`.`patient tbl` WHERE 'Resident registration number'='".$_GET['Resident_registration_number']."'";
...
<h1> 환자 삭제 <h1>
<FORM METHOD="post" ACTION="delete_result_DH.php">
주민등록번호 : 
...
<br><h5> <a href='patient_DH.php'> <--환자 조회 화면</a> </h5>
</FORM>	 
