...
<a href='Daegu_main.html'> <--- DAEGU HOME</a>

<font size="6em">

<center><h1>대구 병원 정보 조회 </h1></center>
...
<?php
   ...
   $sql = "SELECT * FROM `systemdb`.`hospital tbl` WHERE `hospital tbl`.`Hospital Name` = 'Daegu'";
   ...
   $sql_h = "SELECT * FROM `patient tbl` WHERE (`Hospitalization date`IS NOT NULL)AND(`Discharge date` IS NULL)AND(`hospital tbl_Hospital Name` = 'Daegu')";
   ...
   if($ret_h) {
      ...
      if($Number_of_hospitalized_patient==0) 
     {
         ...
         echo "<br> <a href='Daegu_main.html'> <--DAEGU HOME</a> ";
         exit();
   }}
   
   $sql_d = "SELECT * FROM `patient tbl` WHERE (`Discharge date`IS NOT NULL)AND(`Date of death` IS NULL)AND(`hospital tbl_Hospital Name` = 'Daegu')";
   ...
   $sql_p = "SELECT * FROM `patient tbl` WHERE (`Date of death`IS NOT NULL)AND(`hospital tbl_Hospital Name` = 'Daegu')";
   ...
   $sql_c = "SELECT * FROM `patient tbl` WHERE (`COVID-19 confirmed` = 'Y')AND(`hospital tbl_Hospital Name` = 'Daegu')";
   ...
   $sql_v1 = "SELECT * FROM `systemdb`.`patient tbl` WHERE (`Date of 1st vaccination`IS NOT NULL)AND(`Date of 2nd vaccination`IS NULL)AND(`hospital tbl_Hospital Name` = 'Daegu')";
   ...
   $sql_v2 = "SELECT * FROM `systemdb`.`patient tbl` WHERE (`Date of 1st vaccination`IS NOT NULL) AND (`hospital tbl_Hospital Name` = 'Daegu') AND (`Date of 2nd vaccination`IS NOT NULL)";
...
$row = mysqli_fetch_array($ret);
      ...
      echo "<TD>", "<a href= 'Daegu_info_update.php?Hospital Name=", $row['Hospital Name']. "'>수정</a></TD>";
      echo "</TR>";
